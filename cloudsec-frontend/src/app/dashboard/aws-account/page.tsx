        ...
        {showInstructions && (
          <div className="text-sm space-y-4">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-green-700 dark:text-green-400 mb-2">1. CloudFormation Template (Recommended)</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">Use this CloudFormation template to automatically create the IAM role:</p>
...
Outputs:
  RoleArn:
    Value: !GetAtt CloudSecScanRole.Arn`}
              ...
              <div>
                <h3 className="font-semibold text-orange-700 dark:text-orange-400 mb-2">2. Manual Creation</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">Or manually create the IAM role with this trust policy:</p>
